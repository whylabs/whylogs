...
def profile_viewer(profiles: List[DatasetProfile] = None, reference_profiles: List[DatasetProfile] = None, output_path=None) -> str:
    ...
    try:
        ...
        index_path = os.path.abspath(os.path.join(
            _MY_DIR, os.pardir, "viewer/templates", "index.html"))
    ...
    if profiles:
        ...
        if reference_profiles:
            reference_profile_jsons = [message_to_json(
                each_prof.to_summary()) for each_prof in reference_profiles]
    ...
    index_path = os.path.abspath(os.path.join(
        _MY_DIR, os.pardir, "viewer/templates", "index-hbs-cdn-all-in.html"))
