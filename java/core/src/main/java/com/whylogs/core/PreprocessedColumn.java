...
public class PreprocessedColumn {
  /**
   * View of a column with data of various underlying storage. we preprocess values into typed lists
   * for downstream consumers. We also track the null count and ensure that processed lists/Series
   * don't contain null values.
   */
