...
public class VarianceM2Result {
  ...
  public static VarianceM2Result parallelVarianceM2(
      VarianceM2Result first, VarianceM2Result second) {
    ...
    double m2 =
        first.getM2() + second.getM2() + Math.pow(delta, 2) * first.getN() * second.getN() / n;

    return new VarianceM2Result(n, mean, m2);
  }

  public static VarianceM2Result welfordOnlineVarianceM2(
      VarianceM2Result existing, double new_value) {
