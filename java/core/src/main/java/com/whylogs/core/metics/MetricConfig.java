...
public class MetricConfig {
    ...
    static{
        ...
        unicode_ranges.put("basic-latin", new ArrayList<Integer>(){{
            add(0x0000);
            add(0x007F);
        }});
        unicode_ranges.put("emoticon", new ArrayList<Integer>(){{
            add(0x1F600);
            add(0x1F64F);
        }});
        unicode_ranges.put("control", new ArrayList<Integer>(){{
            add(0x0000);
            add(0x001F);
        }});
        unicode_ranges.put("digit", new ArrayList<Integer>(){{
            add(0x0030);
            add(0x0039);
        }});
        unicode_ranges.put("latin-upper", new ArrayList<Integer>(){{
            add(0x0061);
            add(0x007A);
        }});
        unicode_ranges.put("latin-lower", new ArrayList<Integer>(){{
            add(0x0041);
            add(0x005A);
        }});
        unicode_ranges.put("extended-latin", new ArrayList<Integer>(){{
            add(0x0080);
            add(0x02AF);
        }});
    }
