...
public class TestDeserializer {
    ...
    public void test_derializationRegistry(){
        ...
        MetricComponentMessage message = MetricComponentMessage.newBuilder().setTypeId(1).setN(20).build();
    ...
    public void test_floatDeserialization(){
        MetricComponentMessage f_message = MetricComponentMessage.newBuilder().setTypeId(2).setD(20.0).build();
