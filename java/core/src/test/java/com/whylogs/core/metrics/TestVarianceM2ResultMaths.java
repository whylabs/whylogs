...
public class TestVarianceM2ResultMaths {
    ...
    public void test_parallel_variance_m2(){
        ...
        Assert.assertEquals(result.getM2(), m2_a + m2_b + Math.pow((mean_a - mean_b), 2) * n_a * n_b / (n_a + n_b));
    }
    ...
    public void test_welford_online_variance_m2(){
        ...
        double new_value = 2;
        VarianceM2Result actual_result = VarianceM2Result.welfordOnlineVarianceM2(existing_aggregate, new_value);
