...
public class TestColumnProfile {
    ...
    private ColumnProfile<Integer> getDefaultColumnProfile(){
        ColumnSchema standardSchema = new ColumnSchema(Integer.class, new MetricConfig(), new StandardResolver());
    ...
    public void testAddMetric(){
        ...
        IntegralMetric metric2 = new IntegralMetric(new MaxIntegralComponent(22), new MinIntegralComponent(20));
