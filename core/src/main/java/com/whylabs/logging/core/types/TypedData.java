...
public class TypedData {
  private static final TypedData UNKNOWN_INSTANCE =
      TypedData.builder().setType(Type.UNKNOWN).build();
  private static final TypedData BOOLEAN_TRUE_INSTANCE =
      TypedData.builder().setType(Type.BOOLEAN).setBooleanValue(true).build();
  private static final TypedData BOOLEAN_FALSE_INSTANCE =
      TypedData.builder().setType(Type.BOOLEAN).setBooleanValue(false).build();
