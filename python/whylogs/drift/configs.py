...
class KSTestConfig:
    ...
    thresholds: DriftThresholds = DriftThresholds(NO_DRIFT=(0.15, 1.1), POSSIBLE_DRIFT=(0.05, 0.15), DRIFT=(0, 0.05))
...
class HellingerConfig:
    ...
    min_n_buckets: int = 2
    thresholds: DriftThresholds = DriftThresholds(NO_DRIFT=(0, 0.15), POSSIBLE_DRIFT=(0.15, 0.4), DRIFT=(0.4, 1.1))
